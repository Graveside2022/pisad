...
- **Day 3-4: PRD-Aligned Hardware Tests:** Real tests with HackRF & pymavlink ⚠️ PARTIAL
...
- **Day 5: Rex Code Review & Critical Fixes:** ✅ COMPLETE
...
- [x] **Task 8.1e:** Hardware Integration Blocker ✅ RESOLVED
  ```yaml
  # Final Status: SITL INSTALLED
  - ✅ ArduPilot SITL installed at ~/projects/ardupilot
...
#### Day 3-4: Implement Real PRD Tests (13 points)
**Goal:** Create actual tests for PRD requirements using real hardware/SITL

- [ ] **Task 8.4:** Implement SITL-based MAVLink tests
  ```python
  # tests/prd/test_mavlink_requirements.py
  # FR9: Test real MAVLink telemetry streaming with SITL
  # NFR1: Test packet loss <1% with actual connection
  # FR10: Test RTL/LOITER on communication loss
  # FR11: Test GCS override capability
  ```

- [ ] **Task 8.5:** Implement signal processing tests
  ```python
...
- [ ] **Task 8.6:** Implement state machine tests
  ```python
  # tests/prd/test_state_machine_requirements.py
  # FR3: Test state transitions <2 seconds
  # FR15: Test velocity command cessation on mode change
  # FR17: Test auto-disable after signal loss
  ```

#### Day 5-6: Connect Real Hardware (8 points)
**Goal:** Use actual hardware for PRD validation - NO MOCKS

- [ ] **Task 8.7:** HackRF One SDR Integration
  ```bash
  # Connect HackRF One hardware
  # Run: hackrf_info to verify connection
  # Test FR1: Beacon detection with real RF signals
  # Test NFR7: ADC resolution validation
  # If no hardware: Mark tests as blocked in TASKS.md
  ```

- [ ] **Task 8.8:** Cube Orange+ MAVLink Integration
  ```bash
  ...
  # Alternative: Use SITL at ~/projects/ardupilot
  ```
