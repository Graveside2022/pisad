...
- Current Coverage: 16.58% (1,349 statements) 
- Target Coverage: 60.00% (4,121 statements)
- Progress Made: +1.79% (+133 statements)
- Remaining Gap: 43.42% (2,772 statements)
...
- [ ] **Audit all test files for duplicates** - Check all 66 test files listed above (Foundation)
  - State Machine: 4 duplicate files (keep only comprehensive)
  - Waypoint Exporter: 2 duplicate files (keep enhanced)
  - Telemetry: 3 files (determine which to keep)
  - Homing: 5 files (keep comprehensive versions)
- [ ] **Remove duplicate test files** - After careful verification (Foundation)
  - [ ] Verify tests in duplicate files before removal
  - [ ] Merge unique tests from duplicates into main file
  - [ ] Remove only after confirming no test loss
- [ ] **Fix async test issues causing hangs** - 18 files with async tests (Foundation)
  - [ ] Add proper async test fixtures
  - [ ] Fix event loop handling
  - [ ] Add timeouts to prevent hanging
- [ ] **Audit test effectiveness** - Verify tests actually test code, not just pass (Foundation)
  - [ ] Check test assertions are meaningful
  - [ ] Verify mocks match actual implementations
  - [ ] Ensure coverage is real, not artificial
...
**Coverage Improvements (Current Session - 2025-08-14):**
...
1. **Current Session (2025-08-14 Latest)**: 
...
**Modified (Current Session - 2025-08-14 Latest):**
...
- docs/stories/4.2.story.md (added critical cleanup tasks, test audit requirements, and complete file inventory)

**Removed (Current Session - 2025-08-14 Latest):**
