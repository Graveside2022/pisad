...
class ASVConfigurationManager:
    ...
    def create_frequency_profile(self, profile: ASVFrequencyProfile, 
                                save: bool = True) -> None:
    ...
    def create_analyzer_profile(self, profile: ASVAnalyzerProfile,
                               save: bool = True) -> None:
    ...
    def get_configuration_summary(self) -> Dict[str, Any]:
        ...
        return {
            "global_config": {
                ...
                "safety_compliance": self.get_global_config("safety_integration.safety_authority_compliance"),
            },
            "frequency_profiles": {
