...
class TestSafetyPerformanceValidation:
    ...
    @pytest.mark.asyncio
    async def test_emergency_stop_performance_requirement(self, safety_system, dual_coordinator):
        ...
        for i in range(5):
            ...
            await safety_system.trigger_coordination_emergency_stop(f"Performance test {i+1}")
        ...
        assert (
            max_response < 500.0
        ), f"Max emergency response {max_response:.1f}ms exceeds 500ms limit"
        ...
        assert (
            std_dev < 50.0
        ), f"Response time std dev {std_dev:.1f}ms indicates inconsistent performance"

    @pytest.mark.asyncio
    async def test_coordination_health_check_performance(self, safety_system, dual_coordinator):
    ...
    @pytest.mark.asyncio
    async def test_dual_source_signal_check_performance(self, safety_system, dual_coordinator):
    ...
    @pytest.mark.asyncio
    async def test_safety_monitoring_loop_performance(self, safety_system, dual_coordinator):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_safety_operations_performance(self, safety_system, dual_coordinator):
    ...
    async def test_safety_response_under_load(self, safety_system, dual_coordinator):
        ...
        try:
            ...
            await safety_system.trigger_coordination_emergency_stop("Emergency under load test")
    ...
    @pytest.mark.asyncio
    async def test_deterministic_timing_consistency(self, safety_system, dual_coordinator):
