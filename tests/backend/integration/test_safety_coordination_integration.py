...
class TestSafetyCoordinationIntegration:
    ...
    @pytest.mark.asyncio
    async def test_safety_system_with_coordination_active(
    ...
    @pytest.mark.asyncio
    async def test_safety_emergency_stop_with_coordination(
        self, safety_system, dual_coordinator
    ):
    ...
    @pytest.mark.asyncio
    async def test_dual_source_signal_monitoring(
        self, safety_system, dual_coordinator
    ):
    ...
    @pytest.mark.asyncio
    async def test_coordination_health_monitoring(
        self, safety_system, dual_coordinator
    ):
    ...
    @pytest.mark.asyncio 
    async def test_safety_fallback_on_coordination_failure(
        self, safety_system, dual_coordinator
    ):
    ...
    @pytest.mark.asyncio
    async def test_safety_event_logging_with_coordination(
        self, safety_system, dual_coordinator
    ):
