...
from src.backend.services.homing_algorithm import GradientVector, HomingAlgorithm
...
class TestHomingDopplerIntegration:
    ...
    def test_doppler_compensation_disabled_no_velocity(self, homing_algorithm):
        ...
        original_gradient = GradientVector(magnitude=0.5, direction=45.0, confidence=0.8)
