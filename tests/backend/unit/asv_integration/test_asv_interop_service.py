...
class TestASVInteropService:
    ...
    def test_pythonnet_import_available(self):
        ...
        try:
            ...
            pytest.fail(f".NET runtime configuration failed: {e}. Ensure .NET Core is installed at {dotnet_root}")
    ...
    def test_asv_assembly_loading_infrastructure_exists(self):
        ...
        try:
            ...
            assert hasattr(service, 'load_asv_assembly'), "Service should have load_asv_assembly method"
            assert hasattr(service, 'get_analyzer_types'), "Service should have get_analyzer_types method"
            assert hasattr(service, 'create_analyzer_instance'), "Service should have create_analyzer_instance method"
    ...
    def test_asv_dotnet_assembly_detection(self):
        ...
        try:
            ...
            assert assembly_path.endswith("ASV.Drones.Sdr.Core.dll"), "Should find correct ASV assembly"
    ...
    def test_basic_dotnet_interop_functionality(self):
        ...
        try:
            ...
            found_analyzers = [t for t in analyzer_types if any(expected in str(t) for expected in expected_analyzers)]
            assert len(found_analyzers) > 0, f"Should find expected analyzer interfaces, got: {analyzer_types}"
    ...
    async def test_dotnet_task_to_python_asyncio_bridging(self):
        ...
        try:
            ...
            assert hasattr(service, 'bridge_dotnet_task_async'), "Service should support async .NET task bridging"
            ...
            assert bridge_latency_ms < 100.0, f"Async bridge latency {bridge_latency_ms:.2f}ms exceeds 100ms requirement"
