...
class TestTask552CommunicationLossDetection:
    ...
    @pytest.mark.asyncio
    async def test_communication_loss_detection_with_timeout(self, bridge_service, mock_safety_manager):
        """
    ...
    async def test_automatic_notification_system(self, bridge_service):
        ...
        await bridge_service.auto_notify_communication_issue("latency_degradation", {"latency": 200.0})
