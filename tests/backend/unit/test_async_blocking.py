...
from src.backend.utils.async_io_helpers import (
    AsyncFileIO, AsyncDatabasePool, AsyncBatchProcessor
...
class TestAsyncDatabasePool:
    ...
    async def test_pool_connection_reuse(self, tmp_path):
        ...
        await asyncio.gather(*[
            use_connection(i) for i in range(5)
        ])
